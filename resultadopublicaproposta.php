                        ...
                        <?php  
                                ...
                                <div class='text-center'>
                                    ...
                                    <div class=''>
                                        ...
                                        <div class='form-group col-lg-6 text-center'>
                                            <p class='lead text-success'> <strong>Sua proposta de projeto foi registrada com sucesso!</strong></p>";
                                ...
                                <div class='text-center'>
                                    ...
                                    <div class=''>
                                        ...
                                        <div class='form-group col-lg-6 text-center'>
                                            <p class='lead text-danger'> <strong>Ocorreu um erro ao realizar o seu registro da sua proposta de projeto. Tente novamente!</strong></p>";
                                }
                        ?>
